...
public class McfCheckerTest {
  ...
  public void checkBasic() throws IOException {
    String mcf = "Node: USState\n" +
                 "name: \"California\"";
    assertTrue(failure(mcf, "Sanity_MissingOrEmpty_typeOf",
            "property typeOf in node USState"));
  ...
  public void checkDcid() throws IOException {
    ...
    assertTrue(failure(mcf, "Sanity_MultipleDcidValues",
            "dcid must have exactly one"));

    // DCID must not be too long.
    mcf = "Node: USState\n" +
          "typeOf: schema:State\n" +
          "dcid: " + new String(new char[257]).replace('\0', 'x');
  ...
  public void checkPopObs() throws IOException {
    ...
    assertTrue(failure(mcf, "Sanity_ObsMissingValueProp",
            "Missing any value property"));
    ...
    mcf = "Node: USStateFemalesIncome\n" +
            ...
            "unit: \"AnnualUSDollars\"\n" +
            "medianValue: 200000\n";
    assertTrue(failure(mcf, "Sanity_MissingOrEmpty_observationDate",
            "observationDate"));
  ...
  public void checkStatVar() throws IOException {
    ...
    assertTrue(failure(mcf, "Sanity_MissingOrEmpty_populationType",
            "populationType in node SV"));
    ...
    mcf = "Node: SV\n" +
            ...
            "measuredProperty: dcs:count\n" +
            "statType: dcs:measuredValue";
            assertTrue(failure(mcf,
                    "Sanity_NotInitUpper_populationType", "person"));
    ...
    mcf = "Node: SV\n" +
            ...
            "populationType: schema:Person\n" +
            "statType: dcs:measuredValue";
    assertTrue(failure(mcf, "Sanity_MissingOrEmpty_measuredProperty",
            "measuredProperty in node SV"));
  ...
  public void checkSVObs() throws IOException {
    ...
    String mcf = "Node: SFWomenIncome2020\n" +
    ...
    mcf = "Node: SFWomenIncome2020\n" +
            ...
            "observationAbout: dcid:geoId/SF\n" +
            "observationDate: \"2020\"\n";
    assertTrue(failure(mcf, "Sanity_MissingOrEmpty_value",
            "value in node SFWomenIncome2020"));
    ...
    mcf = "Node: SFWomenIncome2020\n" +
            ...
            "observationAbout: dcid:geoId/SF\n" +
            "observationDate: \"2020\"\n";
    assertTrue(failure(mcf, "Sanity_MissingOrEmpty_variableMeasured",
    ...
    mcf = "Node: SFWomenIncome2020\n" +
            ...
            "variableMeasured: dcid:WomenIncome\n" +
            "observationDate: \"2020\"\n";
    assertTrue(failure(mcf, "Sanity_MissingOrEmpty_observationAbout",
    ...
    mcf = "Node: SFWomenIncome2020\n" +
            ...
            "variableMeasured: dcid:WomenIncome\n" +
            "observationAbout: dcid:geoId/SF\n";
    assertTrue(failure(mcf, "Sanity_InvalidObsDate",
            "non-ISO8601 compliant value"));
  }

  @Test
  public void checkSchema() throws IOException {
    // Property names must start with lower case.
    String mcf = "Node: dcid:Place\n" +
            "typeOf: schema:Class\n" +
            "Name: \"Place\"\n" +
            "description: \"Physical location.\"\n";
    assertTrue(failure(mcf, "Sanity_NotInitLowerPropName",
            "'Name' does not start with a lower-case"));
  ...
  public void checkTemplate() throws IOException {
    ...
    String mcf = "Node: E:CityStats->E1\n" +
            "typeOf: State\n" +
            "dcid: C:CityStats->StateId\n" +
            "name: C:CityStats->StateNam\n";
    assertTrue(failure(mcf, "Sanity_TmcfMissingColumn", "'StateNam' referred",
            Set.of("StateId", "StateName")));

    mcf = "Node: E:CityStats->E1\n" +
            "typeOf: State\n" +
            "dcid: C:CityStats->StateId\n" +
    ...
    assertTrue(failure(mcf, "Sanity_TmcfMissingEntityDef", "'E:CityStats->E3'",
  ...
  private static boolean failure(String mcfString, String counter, String message) throws IOException {
